...
This collection includes three Arduino-based projects that reflect my exploration of robotics fundamentals, problem-solving, and human-centered design. From autonomous motion to interactive systems, these works highlight how machines can connect logic with compassion.

### Included Projects
1. **Obstacle Avoidance Robot**  
   Building by following and adapting a YouTube tutorial, this robot detects and avoids obstacles using an ultrasonic sensor. It was my first project applying the Arduino fundamentals I had learned, helping me connect theory to practice. Through experimenting with wiring corrections, motor speed adjustments, and switching to a more suitable power source, I improved its performance, though it only achieved partial success in navigation. This hands-on process provided me valuable experience with Arduino hardware and programming, and taught me how iteration and collaboration are key to meaningful learning. I also realized that even simple autonomous behaviors can be the foundation for creating future robots that interact, respond, and grow alongside people.
...
- 2025 updated wiring diagrams to correct and clarify the original builds and note improvements.
...
### 📎 Author
**Punchita (Nadia) Teerachawansak**  
Student | Robotics and AI Enthusiast  
> Exploring how machines can see, feel, and serve with empathy.
